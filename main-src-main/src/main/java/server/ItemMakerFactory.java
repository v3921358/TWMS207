...
public class ItemMakerFactory {
    ...
    protected ItemMakerFactory() {
        ...
        final MapleData info = MapleDataProviderFactory.getDataProvider("Etc").getData("ItemMake.img");
            ...
            switch (type) {
                case 0: { // Caching of gem
                    for (MapleData itemFolder : dataType.getChildren()) {
                        ...
                        // totalupgrades = MapleDataTool.getInt("tuc", itemFolder, 0); // Gem is always
                        // 0
