...
public class MapleMonsterStats {
    ...
    private byte cp, selfDestruction_action, tagColor, tagBgColor, rareItemDropLevel, HPDisplayType, summonType,
            category;
    private short level, charismaEXP;
    private int hp, id, exp, mp, PDRate, MDRate, removeAfter, buffToGive, fixedDamage, selfDestruction_hp,
            dropItemPeriod, point, eva, acc, PhysicalAttack, MagicAttack, speed, partyBonusR, pushed, skeleton;
    private boolean boss, undead, ffaLoot, firstAttack, isExplosiveReward, mobile, fly, onlyNormalAttack, friendly,
            noDoom, invincible, partyBonusMob, changeable, escort;
    ...
    public void setSkeleton(int skel) {
        this.skeleton = skel;
    }
