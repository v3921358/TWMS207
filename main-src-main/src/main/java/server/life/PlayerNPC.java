...
public class PlayerNPC extends MapleNPC implements MapleCharacterLook {
    ...
    public PlayerNPC(MapleCharacter cid, int npc, MapleMap map, MapleCharacter base) {
        ...
        setCoords(base.getTruePosition().x, base.getTruePosition().y, 0, base.getFh()); // 0 = facing dir? no idea, but
        // 1 dosnt work
        update(cid);
    }
    ...
    public void sendSpawnData(MapleClient client) {
        ...
        client.getSession().writeAndFlush(CWvsContext.spawnPlayerNPC(this));
