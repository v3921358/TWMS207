...
public class GMCommand {
    ...
    public static class PlayerFly extends 玩家飛 {
    }
    ...
    public static class MapFly extends 全圖飛 {
    }
    ...
    public static class GivePet extends 給予寵物 {
    }
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            try {
                MapleInventoryManipulator.addById(petowner.getClient(), id, (short) 1, "",
                        ...
                        c.getPlayer().getName() + "使用" + splitted[0] + "指令製作");
    ...
    public static class GiveSkill extends 獲得技能 {
    }
    ...
    public static class fame extends 增加人氣 {
    }
    ...
    public static class sp extends 技能點 {
    ...
    public static class jobsp extends 轉數技能點 {
    ...
    public static class job extends 職業 {
    }
    ...
    public static class PlayerJob extends 玩家職業 {
    }
    ...
    public static class shop extends 商店 {
    }
    ...
    public static class levelup extends 升級 {
    ...
    public static class levelupto extends 升級到 {
    ...
    public static class 升級到 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            // for (int i = 0; i < Integer.parseInt(splitted[1]) - c.getPlayer().getLevel();
            // i++) {
    ...
    public static class Playerlevelto extends 升級玩家到 {
    ...
    public static class Makepotitem extends 製作潛能道具 {
    ...
    public static class 製作潛能道具 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            int flag = ItemFlag.LOCK.getValue();
            MapleItemInformationProvider ii = MapleItemInformationProvider.getInstance();
            if (itemId >= 2000000) {
                ...
                equip.setGMLog(c.getPlayer().getName() + " 使用 " + splitted[0] + " 指令製作, 時間:"
    ...
    public static class MakeStatItem extends 製作屬性道具 {
    ...
    public static class level extends 等級 {
    ...
    public static class PlayerLevel extends 玩家等級 {
    ...
    public static class StartAutoEvent extends 開始自動事件 {
    ...
    public static class StartEvent extends 開始活動 {
    }

    public static class 開始活動 extends CommandExecute {
    ...
    public static class ClearEvent extends 清除活動 {

    }

    public static class 清除活動 extends CommandExecute {
    ...
    public static class Event extends 活動 {

    }

    public static class 活動 extends CommandExecute {
    ...
    public static class RemovePlayerItem extends 清除玩家道具 {
    }
    ...
    public static class lockitem extends 封印道具 {
    ...
    public static class 封印道具 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            for (Item item : chr.getInventory(type).listById(itemid)) {
                ...
                chr.getClient().getSession().writeAndFlush(InventoryPacket.updateSpecialItemUse(item));
            }
            if (type == MapleInventoryType.EQUIP) {
                type = MapleInventoryType.EQUIPPED;
                for (Item item : chr.getInventory(type).listById(itemid)) {
                    item.setFlag(item.getFlag() | ItemFlag.LOCK.getValue());
                    // chr.getClient().getSession().writeAndFlush(CField.updateSpecialItemUse(item,
                    // type.getType()));
                }
            }
            ...
            World.Broadcast
                    .broadcastSmega(
                            CWvsContext.broadcastMsg(3,
                                    ...
                                    true));
            /*
             * if (splitted.length < 2) { c.getPlayer().dropMessage(-11,
             * "!smega <itemid> <message>"); return 0; } final List<String> lines = new
             * LinkedList<>(); for (int i = 0; i < 4; i++) { final String text =
             * StringUtil.joinStringFrom(splitted, 2); if (text.length() > 55) { continue; }
             * lines.add(text); } final boolean ear = true;
             * World.Broadcast.broadcastSmega(CWvsContext.getAvatarMega(c.getPlayer(),
             * c.getChannel(), Integer.parseInt(splitted[1]), lines, ear));
             */
            return 1;
        }
    }
    ...
    public static class SpeakMega extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            /*
             * if (splitted.length < 2) { c.getPlayer().dropMessage(-11,
             * "!smega <itemid> <victim> <message>"); return 0; } final List<String> lines =
             * new LinkedList<>(); for (int i = 0; i < 4; i++) { final String text =
             * StringUtil.joinStringFrom(splitted, 3); if (text.length() > 55) { continue; }
             * lines.add(text); } final boolean ear = true;
    ...
    public static class OnlineSpeak extends 線上說話 {
    ...
    public static class PlayerSpeak extends 玩家說話 {
    ...
    public static class MapDisease extends 全圖異常狀態 {
    ...
    public static class PlayerDisease extends 玩家異常狀態 {
    ...
    public static class cloneme extends 克隆我 {
    ...
    public static class DisabledClone extends 清除克隆 {
    ...
    public static class MapPlayer extends 全圖玩家 {
    ...
    public static class 全圖玩家 extends CommandExecute {
        ...
        @Override
        public int execute(MapleClient c, String[] splitted) {
            StringBuilder builder = new StringBuilder("當前地圖的玩家: 總共")
                    .append(c.getPlayer().getMap().getCharactersThreadsafe().size()).append("個, ");
    ...
    public static class SetEventVirtue extends 設置事件實例屬性 {
    ...
    public static class EventVirtue extends 事件實例屬性 {
    ...
    public static class CloseEventVirtue extends 離開事件實例 {
    ...
    public static class StartEventVirtue extends 開始事件實例 {
    ...
    public static class killmonsterbyoid extends 殺OID怪物 {
    ...
    public static class resetMob extends 重置怪物 {
    ...
    public static class resetNpc extends 重置NPC {
    ...
    public static class gameMessage extends 聊天公告 {
    ...
    public static class notice extends 公告事項 {
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 2) {
                ...
                c.getPlayer().dropMessage(-11,
                        splitted[0] + "類型:1/2/3/4/5/6/7/8/n/彈窗 - p/頻道廣播 - l/紅字[公告事項] - nv/紅字 - v/无[公告事項] - b");
                return 0;
            }
            int joinmod = 1;
            int range = -1;
    ...
    public static class myip extends 我的IP {
    ...
    public static class tempbanip extends 限時鎖IP {

    }

    public static class 限時鎖IP extends 限時鎖帳 {
    ...
    public static class tempbanaccount extends 限時鎖帳 {

    }

    public static class 封鎖IP extends 封鎖帳號 {
    ...
    public static class 限時鎖MAC extends 限時鎖帳 {
    ...
    public static class 封鎖MAC extends 封鎖帳號 {
    ...
    public static class toggleDrop extends 掉寶開關 {
    ...
    public static class jail extends 監禁 {
    ...
    public static class AntiMacro extends 測謊 {

    }

    public static class 測謊 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            MapleCharacter victim = c.getChannelServer().getPlayerStorage().getCharacterByName(splitted[1]);
            MapleAntiMacro.startAnti(null, victim, MapleAntiMacro.SYSTEM_ANTI);
            return 1;
        }
    }

    public static class looknpc extends 查看NPC {
        ...
        public int execute(MapleClient c, String[] splitted) {
            for (MapleMapObject reactor1l : c.getPlayer().getMap().getAllNPCsThreadsafe()) {
                ...
                c.getPlayer().dropMessage(5, "NPC: oID: " + reactor2l.getObjectId() + " npcID: " + reactor2l.getId()
                        + " 坐標: " + reactor2l.getPosition().toString() + " 名稱: " + reactor2l.getName());
            }
            return 0;
        }
    }

    public static class lookreactor extends 查看反應堆 {
        ...
        public int execute(MapleClient c, String[] splitted) {
            for (MapleMapObject reactor1l : c.getPlayer().getMap().getAllReactorsThreadsafe()) {
                ...
                c.getPlayer().dropMessage(5,
                        "反應堆: oID: " + reactor2l.getObjectId() + " 反應堆ID: " + reactor2l.getReactorId() + " 坐標: "
                        + reactor2l.getPosition().toString() + " 狀態: " + reactor2l.getState() + " 名稱: "
                        + reactor2l.getName());
            }
            return 0;
        }
    ...
    public static class lookportal extends 查看傳送點 {
    ...
    public static class 查看傳送點 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            for (MaplePortal portal : c.getPlayer().getMap().getPortals()) {
                c.getPlayer().dropMessage(5,
                        "傳送點: ID: " + portal.getId() + " 腳本: " + portal.getScriptName() + " 名稱: " + portal.getName()
                        + " 坐標: " + portal.getPosition().x + "," + portal.getPosition().y + " 目標地圖: "
    ...
    public static class mypos extends 我的位置 {
    ...
    public static class 我的位置 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(-11, "X: " + pos.x + " | Y: " + pos.y + " | RX0: " + (pos.x + 50) + " | RX1: "
                    + (pos.x - 50) + " | FH: " + c.getPlayer().getFh());
            return 1;
        }
    }

    public static class letter extends 字母 {
    ...
    public static class spawn extends 召喚 {
    ...
    public static class spawnmobname extends 召喚怪物 {
    ...
    public static class 召喚怪物 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            int mid = 0;
            for (Entry<Integer, String> mob : MapleMonsterInformationProvider.getInstance().getAllMonsters()
                    .entrySet()) {
    ...
    public static class mute extends 禁言 {
    ...
    public static class unmute extends 取消禁言 {
    ...
    public static class muteMap extends 全圖禁言 {
    ...
    public static class unmuteMap extends 取消全圖禁言 {
    ...
    public static class Invincible extends 無敵 {
    ...
    public static class online extends 線上玩家 {
    ...
    public static class 線上玩家 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            for (ChannelServer cserv : ChannelServer.getAllInstances()) {
                ...
                c.getPlayer().dropMessage(-11, new StringBuilder().append("頻道: ").append(cserv.getChannel())
                        .append(" 線上人數: ").append(curConnected).toString());
                total += curConnected;
    ...
    public static class searchHack extends 搜外掛 {
            ...
            for (ChannelServer ch : ChannelServer.getAllInstances()) {
                for (MapleCharacter chr : ch.getPlayerStorage().getAllCharacters()) {
                    for (MapleProcess mp : chr.getProcess()) {
                        if (mp.getMD5().equalsIgnoreCase(splitted[1])
                                || mp.getName().toLowerCase().contains(splitted[1].toLowerCase())) {
                            c.getPlayer().dropMessage(5,
                                    chr.getName() + " 存在該進程【\"" + mp.getPath() + "\" MD5值：\"" + mp.getMD5() + "\"】");
                            i++;
                        }
                    }
                }
    ...
    public static class gainMP extends 獲得楓點 {
    ...
    public static class gainMeso extends 楓幣 {
