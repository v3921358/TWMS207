...
public class MapleMapEffect {
    ...
    public byte[] makeDestroyData() { // jukebox doesn't REALLY have a destroy, but 0 stops all music
        return jukebox ? CCashShop.playCashSong(0, "") : CField.removeMapEffect();
    }

    public byte[] makeStartData() {
        return jukebox ? CCashShop.playCashSong(itemId, msg) : CField.startMapEffect(msg, itemId, active);
    }
