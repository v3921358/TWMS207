...
public class MapleGuildCharacter implements java.io.Serializable { // alias for a character
    ...
    private short level;
    private int id, jobCode, subJobCode, guildid, guildContribution;
    ...
    public MapleGuildCharacter(final int id, final short lv, final String name, final byte channel, final int job,
            final int subJob, final byte rank, final int guildContribution, final byte allianceRank, final int gid,
            final boolean on) {
        this.level = lv;
        this.id = id;
        this.name = name;
    ...
    public void setJobCode(int nJobCode) {
        jobCode = nJobCode;
    }
    ...
    public void setSubJobCode(int nSubJobCode) {
        subJobCode = nSubJobCode;
    }
