...
public class Item implements Comparable<Item>, Serializable {
    ...
    public Item(final int id, final short position, final short quantity, final int flag, final int uniqueid,
            short pos) {
        super();
        this.id = id;
    ...
    public Item(final int id, final short position, final short quantity, final int flag) {
        super();
        this.familiarCard = null;
        this.id = id;
        this.position = position;
        this.quantity = quantity;
        this.flag = flag;
    ...
    public Item(int id, final short position, short quantity) {
        super();
        this.familiarCard = null;
        this.id = id;
        this.position = position;
    ...
    public Item copy() {
        final Item ret = new Item(id, position, quantity, flag, uniqueid, pos);
        ret.pet = pet;
        ret.owner = owner;
    ...
    public Item copyWithQuantity(final short qq) {
        final Item ret = new Item(id, position, qq, flag, uniqueid, pos);
        ret.pet = pet;
        ret.owner = owner;
        ret.GameMaster_log = GameMaster_log;
        ret.expiration = expiration;
    ...
    public void setFamiliarCard(FamiliarCard card) {
        this.familiarCard = card;
    }
    ...
    public void removeFlag(int flag) {
        this.flag = this.flag & (flag ^ 0xFFFFFFFF);
    }
