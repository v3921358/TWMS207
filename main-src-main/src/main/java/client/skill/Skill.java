...
public class Skill implements Comparator<Skill> {
    ...
    public boolean isTeachSkills() {
        switch (this.id) {
            case 110: // 百烈祝福。
            case 1214: // 寶盒的護佑
            case 10000255: // 西格諾斯祝福（劍士）
            case 10000256: // 西格諾斯祝福（法師）
            case 10000257: // 西格諾斯祝福（弓箭手）
            case 10000258: // 西格諾斯祝福（盜賊）
            case 10000259: // 西格諾斯祝福（海盜）
            case 20021110: // 精靈的祝福
            case 20030204: // 致命本能
            case 20040218: // 滲透
            case 20050286: // 死裡逃生
    ...
    public boolean isLinkSkills() {
        switch (this.id) {
            case 80000000: // 百烈祝福
            case 80001151: // 寶盒的護佑
            case 80000066: // 西格諾斯祝福(聖魂)
            case 80000067: // 西格諾斯祝福(烈焰)
            case 80000068: // 西格諾斯祝福(破風)
            case 80000069: // 西格諾斯祝福(暗夜)
            case 80000070: // 西格諾斯祝福(閃雷)
            case 80001040: // 精靈的祝福
            case 80000002: // 致命本能
            case 80000005: // 波米艾特
            case 80000169: // 死裡逃生
