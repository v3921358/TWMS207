...
public class CheatingOffenseEntry {
     ...
     * prime * result + ((offense == null) ? 0 : offense.hashCode()); return result;
     * }
     * 
     * @Override public boolean equals(Object obj) { if (this == obj) { return true;
     * } if (obj == null) { return false; } if (getClass() != obj.getClass()) {
     * return false; } final CheatingOffenseEntry other = (CheatingOffenseEntry)
     * obj; if (chrfor == null) { if (other.chrfor != null) { return false; } } else
     * if (chrfor.getId() != other.chrfor.getId()) { return false; } if (offense ==
     * null) { if (other.offense != null) { return false; } } else if
