...
public class BuffInformation {
    ...
    public static void start(String[] args) {
        ...
        if (export) {
            dumpSkills();
            for (Pair<Integer, Character> c : a) {
    ...
    public static StringBuilder getSkillInformation(int skill) {
        ...
        MapleDataProvider prov = MapleDataProviderFactory.getDataProvider("Skill");
    ...
    public static void dumpSkills() {
        ...
        for (MapleDataFileEntry data : root.getFiles()) {
            ...
            for (MapleData sub : prov.getData(data.getName()).getChildren()) {
                if (!sub.getName().equals("skill")) {
                    continue;
                }
                for (MapleData sub2 : sub.getChildren()) {
    ...
    public static String[] opt = { "icon", "iconMouseOver", "iconDisabled", "invisible", "level", "effect", "affected",
            ...
            "hyper", "reqLev", "psdSkill", "prepare", "prepare_1H", "keydown", "keydown_1H", "gaugemax", "gaugemax_1H",
            "attected", "afterimage", "special0", "effect3", "info2", "keydownend", "prepare0", "keydown0", "damage",
            "effectR", "pvpCommon", "number", "icon1", "icon2", "icon3", "icon4", "icon5", "effect4", "specialAffected",
            "subWeapon", "repeat2", "tile0", "keydownloop", "exceedInfo", "weapon ", "finish0", "back_effect0",
            "back_effect", "back", "back_finish", "sDoor", "oDoor", "eDoor", "ball0", "edgeEffect", "anotherModeInfo",
            "keydownend0", "mob1", "mob2", "fixLevel", "skillpet", "skillDelay", "icon6", "skillpetAction",
            "specialPre", "specialLoop", "specialEnd", "specialLoop0", "special1", "loop", "end", "screen0", "PVP",
            "specialAction", "type", "monkeyAction", "mob3", "mob4", "specialAffcted", "hit0", "hit1", "effect_ship",
            "normalGauge", "commandGauge", "effectCash1_", "effectCash1_1", "effectCash2_", "effectCash2_1",
            "effectCash3_", "effectCash3_1", "vehicleID", "reduceMoveTime", "setItemReason", "setItemPartsCount", "1",
